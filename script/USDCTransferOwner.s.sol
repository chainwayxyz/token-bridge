...
contract USDCTransferOwner is Script {
    ...
    function setUp() public {
        ...
        usdcRolesHolderOwner = vm.envString("USDC_ROLES_HOLDER_OWNER");
    }

    function run() public {
        address usdcRolesHolder = new USDCRolesHolder(usdcRolesHolderOwner);
        FiatTokenV2_2(citreaUSDC).transferOwnership(usdcRolesHolder);
    }
}